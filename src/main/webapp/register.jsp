...
<header class="bg-blue-600 text-white py-6 shadow-md">
    <div class="container mx-auto flex justify-between items-center px-6">
        ...
        <div>
            <a href="login.jsp" class="bg-white text-blue-600 px-4 py-2 rounded-lg mr-4 hover:bg-gray-200">Login</a>
            <a href="register.jsp" class="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-gray-200">Register</a>
        </div>
    </div>
</header>
    ...
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="registerServlet" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" required class="w-full px-4 py-2 mt-1 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="password" id="confirmPassword" name="confirmPassword" required class="w-full px-4 py-2 mt-1 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
            </div>
