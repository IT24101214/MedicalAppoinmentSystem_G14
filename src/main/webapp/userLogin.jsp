...
<div class="bg-white shadow-md rounded px-10 pt-8 pb-6 w-full max-w-md border-t-4 border-mint">
  <h2 class="text-2xl font-bold text-mint mb-4 text-center">
    <i class="bi bi-box-arrow-in-right"></i> User Sign In
  </h2>
  ...
  <form action="userLogin" method="post" class="space-y-4">
    <div>
      <label class="block text-gray-700 font-semibold">NIC</label>
      <input type="text" name="userId" required pattern="\d{12}"
             class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-mint"
