<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <header>
        ...
        <main class="hero">
            ...
            <p class="hero-subtitle animate-subtitle">Streamline your healthcare experience with our all-in-one
                appointment scheduling platform. Connect with doctors, manage your health records, and receive
                personalized care — all in one place</p>
            <button class="cta-btn animate-btn" onclick="window.location.href='${pageContext.request.contextPath}/appointment/addAppointment.jsp'">
