...
<header class="header">
    ...
    <div class="nav-links">
        ...
        <a href="AdminManagementPanel.jsp" class="nav-link">
            <i class="fas fa-cog"></i> Management Panel
        </a>
...
<div class="container">
    ...
    <div class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="scheduleList.jsp" class="sidebar-item">
                    <i class="fas fa-user-md"></i>
                    <span>Doctor Schedules</span>
                </a>
            </li>
            <li>
                <a href="addSchedule.jsp" class="sidebar-item">
    ...
    <div class="main-content">
        ...
        <div class="welcome-section">
            <div class="welcome-text">
                <h1>Welcome, Admin!</h1>
                <p>You're in control — keep the care running smoothly!</p>
            </div>
            <div class="welcome-image">
                <img src="${pageContext.request.contextPath}/images/7355082.png" alt="Admin Dashboard">
            </div>
        </div>
        ...
        <div class="dashboard-cards">
            ...
            <div class="card" onclick="location.href='paymentList.jsp';">
                ...
                <div class="card-description">For the current month revenue</div>
            </div>
        </div>
